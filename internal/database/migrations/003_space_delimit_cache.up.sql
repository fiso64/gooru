-- This migration updates the db_version and changes the tags_cache delimiter.
UPDATE meta SET value = '2' WHERE key = 'db_version';

-- This updates all existing cache entries to use spaces.
...
-- Re-create triggers with space delimiter.
