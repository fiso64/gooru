...
func TestValidateTagRejectsMediaKindKey(t *testing.T) {
	if err := ValidateTag("kind:photo"); err == nil {
		t.Fatal("expected kind to be reserved for virtual media-kind queries")
	}
}
