...
func TestUploadTargetsEndpointHidesPaths(t *testing.T) {
	...
	if got := payload.Items[0].DefaultTags; len(got) != 2 || got[0] != "project:inbox" || got[1] != "-project:archive" {
