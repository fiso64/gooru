...
func TestJPEGFrameIsProgressive(t *testing.T) {
 ...
 cases := []struct {
  ...
  {"progressive SOF2 after APP marker data", []byte{0xff,0xd8,0xff,0xe1,0x00,0x06,0xff,0xc0,0xff,0xc2,0xff,0xc2,0x00,0x0b,0x08,0x00,0x01,0x00,0x01,0x01,0x01,0x11,0x00}, true, false},
  {"extended sequential SOF1", []byte{0xff,0xd8,0xff,0xc1,0x00,0x0b,0x08,0x00,0x01,0x00,0x01,0x01,0x01,0x11,0x00}, false, false},
  {"not JPEG", []byte("not jpeg"), false, true},
  {"truncated progressive frame", []byte{0xff,0xd8,0xff,0xc2,0x00,0x0b,0x08}, false, true},
