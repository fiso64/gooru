...
- **Documentation/configuration:** keep the canonical configuration reference synchronized with option changes and document user-visible operational constraints without turning user docs into internal architecture notes.
