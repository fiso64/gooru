...
replace("docs/openapi.yaml", "          enum: [name, modified, size, kind]\n          default: name", "          enum: [added, name, modified, size, kind]\n          default: added")
replace("docs/openapi.yaml", "          enum: [asc, desc]\n          default: asc", "          enum: [asc, desc]\n          default: desc")
replace("docs/openapi.yaml", "          enum: [name, modified, size, kind]", "          enum: [added, name, modified, size, kind]")
replace("frontend/src/lib/api/client.ts", "type FileSort = 'name' | 'modified' | 'size' | 'kind';", "type FileSort = 'added' | 'name' | 'modified' | 'size' | 'kind';")
